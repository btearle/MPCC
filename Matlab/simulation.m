...
for i = 1:1
    ...
    [x_up, u_up, b, exitflag,info] = optimizer1(TrackMPC,MPC_vars,ModelParams, n_cars, Y, x, u, x0, uprev);
...
for i = 1: simN
    ...
    %  formulate MPCC problem and solve it
    if QP_iter == 0
        [x, u, b, exitflag,info] = optimizer1(TrackMPC,MPC_vars,ModelParams, n_cars, Y, x, u, x0, uprev);
